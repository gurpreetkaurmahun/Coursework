...
console.log("random",randomInRange);
  ...
  return (
    <div class="navb" style={{ position: "absolute", top: 0, left: 0, right: 0, zIndex: 1 }}>
        ...
        <div className="container-fluid">
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <ul className="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li className="nav-item">
            <div onMouseOver={() => toggleTab(3)} className={toggle === 4 ? "nav-link active butt tabs active-tabs" : "nav-link active butt tabs"} style={{ fontSize: "20",marginLeft:600 }} >
            ...
            <div onMouseOver={() => toggleTab(5)} className={toggle === 4 ? "nav-link active butt tabs active-tabs" : "nav-link active butt tabs"} style={{ fontSize: "20" }} onMouseLeave={hideContent}>
            <svg class="svg-icon" style={{height:30}} viewBox="0 0 20 20">
...
An Ode, where fashion meets poetry. Dive into a world of timeless elegance and contemporary allure. With An Ode, every garment becomes a poetic tribute to individuality, weaving together threads of luxury and creativity to adorn your journey through life's <Link to="/About" style={{textDecoration:"none",fontWeight:"bold",color:"black"}}> know more ..... </Link>
                </p>
              </div>
            ...
            <div className={toggle === 3 ? "content right-active-content" : "content"}>
